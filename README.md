...
[![Join our Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/adhunt3rs)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/AirdropHunt3rs)
...
Click the following link to register: [https://t.me/BlumCryptoBot/](https://t.me/blum/app?startapp=ref_HFXRVYcrKm)
...
2. Clone this repository.
   ```shell
   git clone https://github.com/airdrophunt3rs/BLUMHUNTER.git
   ```

3. Enter the BLUMHUNTER folder
   ```
   cd BLUMHUNTER
   ```
...
``` TLaombfV6rHSBovT6WAbWZ6uZdAKkYuunB ``` - USDT (TRON 20)

``` 0xaa092dc4985ceebbe1fa6239d044ebb8895923b5 ``` - BNB (BEP 20)

## License
This project is licensed under the MIT License - see the LICENSE file for details.

## Contact
For questions or support, please contact [AD HUNTERS TG CHAT](https://t.me/adhunt3rs)
