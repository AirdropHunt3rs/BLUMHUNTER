...
async def main():
    ...
    ___    ____     __  __            __                
   /   |  / __ \   / / / /_  ______  / /____  __________
  / /| | / / / /  / /_/ / / / / __ \/ __/ _ \/ ___/ ___/
 / ___ |/ /_/ /  / __  / /_/ / / / / /_/  __/ /  (__  ) 
/_/  |_/_____/  /_/ /_/\__,_/_/ /_/\__/\___/_/  /____/  

    Auto Claim Bot For Blum - AD Hunters
    Github  : https://github.com/AirdropHunt3rs
    Telegram: https://t.me/adhunt3rs
        {Style.RESET_ALL}"""
...
if __name__ == "__main__":
    os.system("xdg-open https://t.me/adhunt3rs")
    try:
        asyncio.run(main())
